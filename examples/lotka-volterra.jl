 ...
 str = """<?xml version="1.0"?>
    <pnml xmlns="http://www.pnml.org/version-2009/grammar/pnml">
        ...
        <page id="page0">
            ...
            <arc id="a1" source="birth" target="rabbits"> <inscription><text>2</text> </inscription> </arc>
            <arc id="a1" source="wolves" target="predation"> <inscription><text>1</text> </inscription> </arc>
            <arc id="a1" source="rabbits" target="predation"> <inscription><text>1</text> </inscription> </arc>
            <arc id="a1" source="predation" target="wolves"> <inscription><text>2</text> </inscription> </arc>
            <arc id="a1" source="wolves" target="x"> <inscription><text>1</text> </inscription> </arc>
        </page>
        </net>
    </pnml>
""" 
...
u0 = LVector(wolves=10.0, rabbits=100.0) # initialMarking
tspan = (0.0,100.0)
β = LVector(birth=.3, predation=.015, death=.7); # transition condition

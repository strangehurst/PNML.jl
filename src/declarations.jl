...
function parse_declaration(node)
    @debug node
    nn = nodename(node)
...
function parse_condition(node)
    ...
    parse_pnml_label_common!.(Ref(d),elements(node))
    d
end
...
""
function parse_arbitraryoperator(node)
    @debug node
    nn = nodename(node)
...
""
function parse_arbitrarysort(node)
    @debug node
    nn = nodename(node)
...
""
function parse_booleanconstant(node)
    @debug node
    nn = nodename(node)
...
""
function parse_inequality(node)
    @debug node
    nn = nodename(node)
...
""
function parse_mulitsetsort(node)
    @debug node
    nn = nodename(node)
...
""
function parse_namedoperator(node)
    @debug node
    nn = nodename(node)
...
""
function parse_productsort(node)
    @debug node
    nn = nodename(node)
...
""
function parse_useroperator(node)
    @debug node
    nn = nodename(node)
...
""
function parse_variabledecl(node)
    @debug node
    nn = nodename(node)
